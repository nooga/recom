...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Release.mk dist/Release/GNU-Linux-x86/regej

dist/Release/GNU-Linux-x86/regej: ${OBJECTFILES}
...
${OBJECTDIR}/RJGenerator.o: nbproject/Makefile-${CND_CONF}.mk RJGenerator.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/RJGenerator.o RJGenerator.cpp
...
${OBJECTDIR}/RJStateSet.o: nbproject/Makefile-${CND_CONF}.mk RJStateSet.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/RJStateSet.o RJStateSet.cpp

${OBJECTDIR}/RJAutomaton.o: nbproject/Makefile-${CND_CONF}.mk RJAutomaton.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/RJAutomaton.o RJAutomaton.cpp

${OBJECTDIR}/RJStateMachine.o: nbproject/Makefile-${CND_CONF}.mk RJStateMachine.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/RJStateMachine.o RJStateMachine.cpp
...
.clean-conf:
	${RM} -r build/Release
	${RM} dist/Release/GNU-Linux-x86/regej
